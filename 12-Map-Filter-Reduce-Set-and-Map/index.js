// https://www.notion.so/Lecture-12-filter-set-reducer-map-and-set-2873a78e0e2280e192bfc88fa8d0bea7
...
//     return accumulator
// },0);
// jo bhi return karte hai wo accumulator ke andar jaayega 
...
// set ek type ka array samaj lena jahape unique values present ho sakti hai, no duplicates
// for(let num of s1){
//     console.log(num);
// }
...
// object's key can either be string or symbol, even number at the end string me convert hoga , what if I want key as object/ any value
// key value , key can be anything
...
// How to iterate over map, map is kind of 2d array, can use for of loop but by destrucuting if you want key and value